                ...
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <small>Espacio de: <strong>{{ $ownerName ?? 'Propietario' }}</strong> | Rol: <span
                                        class="badge bg-info">Inspector</span></small>
                            </div>
                            <div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-secondary">
                            <i class="bi bi-briefcase"></i> Estás tomando mediciones en el espacio de
                            <strong>{{ $ownerName ?? 'Propietario' }}</strong>
                            <br>
                                        ...
                                        <tr data-sensor-id="{{ $sensor->id }}" data-sensor-name="{{ $sensor->name }}"
                                            ...
                                            <td>
                                                <div class="table-actions">
                                                    @if($isLocked)
                                                        <button class="btn btn-sm btn-secondary opacity-50"
                                                            title="Propietario debe subir de plan"
                                                            onclick="alert('Límite de sensores del propietario alcanzado.'); return false;">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="9" class="text-center py-4">
                                                ...
                                                <p class="text-muted">El propietario de este espacio aún no ha creado sensores.
                                                </p>
                                            </td>
                                        </tr>
                                    @endforelse
    ...
    <script>
        $(document).ready(function () {
            ...
            function updateBulkActions() {
                ...
                // ✅ Tomar Mediciones Masivas solo disponible si > 1 (lógico, porque para 1 se usa la línea directa)
                $('#takeBulkMeasurementBtn').prop('disabled', count < 2);
