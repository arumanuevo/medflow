...
@push('styles')
    <style>
        ...
        .bulk-import-container h5 {
            font-size: 1.1rem;
            font-weight: 600;
        }

        .bulk-import-container p,
        .bulk-import-container li {
            font-size: 0.875rem;
        }

        .bulk-import-container .form-control,
        .bulk-import-container .form-select,
        .bulk-import-container .btn {
            font-size: 0.875rem;
        }
                    ...
                    <div class="card-body">
                        ...
                        <div id="step1" class="step">
                            ...
                            <p class="text-muted">Selecciona el grupo de sensores y sube un archivo <strong>.xlsx</strong> o
                                <strong>.csv</strong> con las mediciones.</p>

                            <div class="alert alert-info">
                                <i class="bi bi-info-circle"></i>
                                <strong>Instrucciones para el archivo:</strong>
                                <ul class="mb-0 mt-2">
                                    <li>El archivo debe contener una columna con el <strong>identificador del
                                            sensor</strong> (nombre, código o ID).</li>
                                    <li>Los valores deben ser <strong>números</strong> (enteros o decimales).</li>
                                    <li>Las fechas deben estar en formato <strong>YYYY-MM-DD</strong> o
                                        <strong>DD/MM/YYYY</strong>.</li>
                                    <li>Puedes importar mediciones para <strong>múltiples sensores</strong> en el mismo
                                        archivo.</li>
                                </ul>
                            </div>
                            ...
                            <div class="alert alert-warning">
                                ...
                                <ul class="mb-0 mt-2">
                                    ...
                                    <li>✅ Las mediciones pueden insertarse en <strong>cualquier punto</strong> de la línea
                                        temporal.</li>
                            ...
                            <div id="groupInfo" class="alert alert-secondary d-none">
                                <i class="bi bi-info-circle"></i>
                                <span id="groupInfoText">Sensores disponibles en este grupo: <strong
                                        id="sensorCount">0</strong></span>
                            </div>
                        ...
                        <div id="step3" class="step d-none">
                            ...
                            <p class="text-muted">Revisa los datos antes de importar. Todas las validaciones se aplicarán en
                                el servidor.</p>
                            ...
                            <div class="alert alert-info">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="overwriteDuplicates">
                                        ...
                                        <span class="text-muted d-block small">Si se encuentra un registro con la misma
                                            fecha y valor, se eliminará el existente y se importará el nuevo.</span>
                                    </label>
                                </div>
                            </div>
