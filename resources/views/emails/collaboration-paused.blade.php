...
<head>
    ...
    <style>
        ...
        .btn { display: inline-block; background: #dc3545; color: white; padding: 10px 25px; text-decoration: none; border-radius: 6px; }
...
<body>
    <div class="container">
        <div class="header">
            <h1>⏸️ Acceso pausado</h1>
        </div>
        <div class="content">
            <p>Hola <strong>{{ $collaborator->user->name }}</strong>,</p>
            <p>
                <strong>{{ $owner->name }}</strong> ha <strong>pausado</strong> tu acceso al espacio de trabajo <strong>{{ $workspaceName }}</strong>.
            </p>
            <p>Esto significa que temporalmente no podrás:</p>
            <ul>
            ...
            <p>
                El propietario podrá reanudar tu acceso en cualquier momento.
                Recibirás una notificación cuando tu acceso sea reanudado.
            </p>
            <div style="text-align: center; margin: 20px 0;">
                <a href="{{ url('/dashboard') }}" class="btn">Ir al Dashboard</a>
            </div>
            <p style="font-size: 13px; color: #6c757d;">
                Si tienes preguntas, contacta al propietario del espacio.
            </p>
        </div>
        <div class="footer">
