            ...
            <div class="card-body">
                <form id="sensorEditForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="identifier" name="identifier" value="{{ $sensor->identifier }}" required>
                        <div class="form-text">Ej: SENSOR-001</div>
                    </div>

                    <div class="mb-3">
                        <label for="description" class="form-label">Descripción</label>
                        <textarea class="form-control" id="description" name="description" rows="2">{{ $sensor->description }}</textarea>
                    </div>
