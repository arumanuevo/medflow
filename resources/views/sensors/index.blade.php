                    ...
                    <div class="card-header-tools">
                        ...
                        <div class="search-wrapper">
                            <div class="position-relative w-100">
                                ...
                                <span class="search-clear position-absolute end-0 top-50 translate-middle-y me-2 d-none"
                                    id="searchClear">&times;</span>
                            </div>
                        </div>

                        <!-- MENÚ DE ACCIONES -->
                        <div class="btn-group">
                            <button type="button" class="btn btn-light btn-sm dropdown-toggle" id="actionsDropdown"
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="actionsDropdown">
                                ...
                                <li>
                                    ...
                                    @if($permissions['import_sensors'] ?? false)
                                        <a href="{{ route('sensor-groups.bulk-import') }}" class="dropdown-item"
                                            id="importSensorsLink">
                                ...
                                <li>
                                    <a href="{{ route('bulk-measurements.select') }}" class="dropdown-item">
        ...
        $(document).ready(function () {
            ...
            function getBaseHeaders() {
                return [
                    ...
                    { key: 'identifier', label: 'Identificador <i class="bi bi-key-fill text-primary ms-1" title="El Identificador actúa como KEY (Llave Única) del medidor. Todas las métricas de consumo y los campos extra dinámicos de las plantillas se registrarán y vincularán de forma unívoca a través de esta Key." style="font-size: 0.85rem; cursor: help; opacity: 0.7;"></i>', sortable: true },
