                    ...
                    <div class="col-md-12">
                        ...
                        @if(isset($sensor->group) && isset($sensor->group->template))
                            <div class="row mb-2">
                                ...
                                <div class="col-md-10">
                                    ...
                                    @if($sensor->group->template->is_default)
                                        <span class="template-badge template-type-{{ $sensor->group->template->type }}">Por defecto</span>
                                    @else
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-10">{{ $sensor->group->template->description ?? 'Sin descripción' }}</div>
                            </div>
                            <div class="row mb-2">
            ...
            <div class="modal-body">
                <form id="measurementForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="measurementPhoto" placeholder="URL de la foto (opcional)">
                    </div>
                    @if(isset($sensor->group) && isset($sensor->group->template))
                        <div class="mb-3">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="alert alert-danger">
                    <i class="bi bi-exclamation-triangle"></i> Esta acción no se puede deshacer y eliminará todas las mediciones asociadas a este sensor.
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
