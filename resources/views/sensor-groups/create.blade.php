            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @if(session('info'))
                            <div class="alert alert-{{ session('alert_type', 'warning') }} alert-dismissible fade show"
                                role="alert">
                                <div class="d-flex align-items-start">
                                    <div class="flex-shrink-0">
                                        <i
                                            class="bi bi-{{ session('alert_type') === 'warning' ? 'exclamation-triangle-fill' : 'info-circle-fill' }} fs-3 me-3"></i>
                                    </div>
                                    <div class="flex-grow-1">
                                        ...
                                        <p class="mb-0 small text-muted">
                                            ...
                                            <strong>Consejo:</strong> Un grupo de sensores te permite organizar tus sensores por
                                            proyectos,
                                            ubicaciones o tipos de medición. Por ejemplo: "Sensores Planta Norte", "Mediciones
                                            de Agua", etc.
                                        </p>
                                    </div>
                                </div>
                        ...
                        <form id="sensorGroupForm">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-text">La plantilla define los campos que tendrán las mediciones de este
                                    grupo.</div>
                            ...
                            <div class="card mt-4 border-info">
                                ...
                                <div class="card-body">
                                    <div class="form-check form-switch mb-3">
                                        <input class="form-check-input" type="checkbox" id="billingEnabled">
