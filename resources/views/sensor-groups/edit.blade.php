                ...
                <div class="card-body">
                    <form id="sensorGroupForm">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="groupDescription" rows="2">{{ $group->description ?? '' }}</textarea>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="template-info mt-2" id="templateInfo">
                                ...
                                <p id="templateDescriptionText">{{ $group->template->description ?? 'Sin descripción' }}</p>
