                    ...
                    <div class="card-body">
                        ...
                        <form id="templateForm">
                            ...
                            <p class="text-muted">
                                ...
                                <br>
                                <small class="text-muted">
                                    <i class="bi bi-info-circle"></i> El inspector se asigna automáticamente cuando tomas
                                    una medición.
                                </small>
                            </p>
                                    ...
                                    <div class="row g-2 align-items-center">
                                        ...
                                        <div class="col-md-2">
                                            <select class="form-select" id="mainFieldContext"
                                                name="schema[campos][0][contexto]" disabled title="Destino del campo">
                                                <option value="medicion" selected>Medición (Dinámico)</option>
                                            </select>
                                        </div>
                                        <div class="col-md-2">
                ...
                <div class="row g-2 align-items-center">
                    ...
                    <div class="col-md-2">
                        <select class="form-select field-context" 
                            ...
                            <option value="medicion" ${context === 'medicion' ? 'selected' : ''}>📝 Medición (Dinámico)</option>
                            <option value="sensor" ${context === 'sensor' ? 'selected' : ''}>⚙️ Sensor (Estático)</option>
                        </select>
                    </div>
                    <div class="col-md-2">
